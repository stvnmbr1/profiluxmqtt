...
import (
	...
	"github.com/cjburchell/profiluxmqtt/profilux/protocol/http"
	"github.com/cjburchell/profiluxmqtt/profilux/protocol/native"
...
func (controller *Controller) IsMaintenanceActive(index int) (types.CurrentState, error) {
	return controller.getDataCurrentState(code.MAINTENANCE_ISACTIVE + getOffset(index, 1, 2))
}
